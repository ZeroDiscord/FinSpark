...
def synthetic_df() -> pd.DataFrame:
    ...
    from ML.data.synthetic.generator import generate_dataset
    df = generate_dataset(
        n_tenants=N_TENANTS,
...
def api_client(markov_model, ngram_model, lstm_trainer, ensemble, session_sequences):
    ...
    from ML.api.main import app, MODEL_STORE, API_KEY_VALUE
...
class TestSyntheticGenerator:
    ...
    def test_features_in_taxonomy(self, synthetic_df):
        from ML.data.synthetic.generator import FEATURES
